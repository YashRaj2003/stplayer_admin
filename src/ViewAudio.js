...
function ViewAudio() {
    ...
    function Delete_Audio() {
        ...
        var desertRefartwork = storageRef.child(`artwork/${params.id + ".jpeg"}`);
        var desertRefaudio = storageRef.child(`audio/${params.id + ".mp3"}`);

        desertRefartwork
            .delete()
            .then(() => {
                // File deleted successfully
                new AWN().success("Artwork successfully deleted!");
            })
            .catch((error) => {
        ...
        desertRefaudio
            ...
            .then(() => {
                // File deleted successfully
                new AWN().success("Audio successfully deleted!");
            })
            .catch((error) => {
                // Uh-oh, an error occurred!
                new AWN().alert(error.message);
        ...
        <div className="min-h-screen bg-dashboard_bg">
            <div className="bg-dashboard_bg min-h-screen text-white">
                <div className="h-24 border-b border-border border-opacity-10 items-center flex px-16 justify-between">
                    <h1 className="text-4xl font-medium">Edit Audio</h1>
                    <button
                        onClick={() => Delete_Audio()}
                ...
                <div className="lg:px-16 px-5 mt-10 pb-32">
                                ...
                                {!audio?.artwork ? <div className="relative">
                                    <div className="lg:w-72 lg:h-72 w-64 h-64 ">
                                        <div className="absolute lg:w-72 lg:h-72 w-64 h-64 hover:shadow-inner cursor-pointer">
                                            <div className="flex justify-end ">
                                                <input type="file" accept=".jpg,.png,.jpeg" className="lg:w-72 lg:h-72 w-64 h-64 opacity-0" />
                                            </div>
                                        </div>
                                    ...
                                    : <div className="lg:w-72 lg:h-72 w-64 h-64 relative hover:shadow-inner">
                                        <div className="absolute right-0 cursor-pointer">
                                            <input type="file" accept=".jpg,.png,.jpeg" className="h-8 w-8 opacity-0 absolute" />
                    ...
                    <div className="bg-card_bg mt-10">
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex lg:flex-row flex-col gap-16 pt-6">
                            ...
                            <div className="grid lg:grid-cols-2 lg:grid-flow-col px-8 py-3 gap-x-5">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setaudios({ ...audios, title: e.target.value })
                                        }
                                ...
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setaudios({ ...audios, title_version: e.target.value })
                                        }
                                        defaultValue={audio?.title_version}
                        ...
                        <div className="py-6">
                            ...
                            <div className="px-8 py-3">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setaudios({ ...audios, artist: e.target.value })
                                    }
                                    defaultValue={audio?.artist}
                            ...
                            <div className="px-8 py-3">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setaudios({ ...audios, producer: e.target.value })
                                    }
                                    defaultValue={audio?.producer}
                                />
                            </div>
                            <div className="grid lg:grid-cols-2 lg:grid-flow-col px-8 py-3 gap-x-5">
                                ...
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setaudios({ ...audios, composer: e.target.value })
                                        }
                                        defaultValue={audio?.composer}
                                    />
                                </div>
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setaudios({ ...audios, lyricst: e.target.value })
                                        }
                                        defaultValue={audio?.lyricst}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid lg:grid-cols-2 lg:grid-flow-col px-8 py-3 gap-x-5">
                                <div className="">
                                    ...
                                    <select name="genre1" id="genre1"
                                        ...
                                        onChange={(e) =>
                                            setaudios({ ...audios, Language: e.target.value })
                                        }
                                    >
                                        <option value="" disabled selected hidden>{audio?.Language ? audio?.Language : "Please Select"}</option>
                                ...
                                <div className="">
                                    ...
                                    <select name="genre2" id="genre2"
                                        className="h-12 w-full bg-white border-b focus:outline-none focus:border-indigo-500 text-black px-5 appearance-none "
                                        onChange={(e) =>
                                            setaudios({ ...audios, mood: e.target.value })
                                        }
                                    >
                                        <option value="" disabled selected hidden>{audio?.mood ? audio?.mood : "Please Select"}</option>
                            ...
                            <div className="grid lg:grid-cols-2 lg:grid-flow-col px-8 py-3 gap-x-5">
                                <div className="">
                                    ...
                                    <select name="genre1" id="genre1"
                                        className="h-12 w-full bg-white border-b focus:outline-none focus:border-indigo-500 text-black px-5 appearance-none "
                                        onChange={(e) =>
                                            setaudios({ ...audios, genre1: e.target.value })
                                        }
                                    >
                                        <option value="" disabled selected hidden>{audio?.genre1 ? audio?.genre1 : "Please Select"}</option>
                                ...
                                <div className="">
                                    ...
                                    <select name="genre2" id="genre2"
                                        className="h-12 w-full bg-white border-b focus:outline-none focus:border-indigo-500 text-black px-5 appearance-none "
                                        onChange={(e) =>
                                            setaudios({ ...audios, genre2: e.target.value })
                                        }
                                    >
                                        <option value="" disabled selected hidden>{audio?.genre2 ? audio?.genre2 : "Please Select"}</option>
                                        <option value="Acoustic">Acoustic</option>
                                        <option value="Bollywood">Bollywood</option>
                                        <option value="Brazallian">Brazallian</option>
                                        <option value="Classical">Classical</option>
                            ...
                            <div className="grid lg:grid-cols-2 lg:grid-flow-col px-8 py-3 gap-x-5">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setaudios({ ...audios, cline: e.target.value })
                                        }
                                        defaultValue={audio?.cline}
                                    />
                                </div>
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        placeholder="2021 Armus Digital Ltd."
                                        onChange={(e) =>
                                            setaudios({ ...audios, pline: e.target.value })
                                        }
                                        defaultValue={audio?.pline}
                                    />
                                </div>
                            </div>
                            <div className="grid lg:grid-cols-2 lg:grid-flow-col px-8 py-3 gap-x-5">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setaudios({ ...audios, label: e.target.value })
                                        }
